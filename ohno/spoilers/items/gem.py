def items():
    gems = {
        ...
        'fluorite stone' : {
            'price':  400,
            'hardness':  'soft',
            'appearances':  ['green gem', 'blue gem', 'white gem',
                             'violet gem'],
...
def appearance_plurals():
    gems = dict(('%s gems' % a, '%s gem' % a)
                    for a in ('white red blue orange black green'
                              ' yellow violet').split())
    gems['yellowish brown gems'] = 'yellowish brown gem'
    gems['gray stones'] = 'gray stone'
    return gems
